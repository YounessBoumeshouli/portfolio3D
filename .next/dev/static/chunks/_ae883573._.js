...
(()=>{
    const e = new Error("Cannot find module '@/utils/readme-parser'");
        ...
        "Portfolio.useEffect": ()=>{
            const loadProjects = {
                "Portfolio.useEffect.loadProjects": async ()=>{
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$github$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchProjects"])();
                        setProjects(data);
                    } catch (err) {
...
//# sourceMappingURL=_ae883573._.js.map